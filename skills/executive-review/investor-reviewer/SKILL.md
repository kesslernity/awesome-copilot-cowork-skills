...
description: Reviews a proposal, business case, deck or plan in character as an Investor archetype, then saves a structured review document with a verdict, findings that cite the artifact, capital-allocation risks and five interrogation questions. Use when the user asks for an investor review, a capital-lens pressure-test of a document, or to prepare for a funding pitch, investment committee or sponsor meeting.
---
...
2. Optional context, ask only if not volunteered: the decision being requested (fund, approve a tranche, proceed), the audience, and the meeting date.
...
3. Check for /Documents/Cowork/org-profile.md in the user's OneDrive. If it exists, read it and use it as company context (business model, stage and size, constraints, sensitivities) throughout the review. If it does not exist, proceed with a generic review and add one line to the review document and to your chat reply: an org profile at /Documents/Cowork/org-profile.md would sharpen this review; the template ships with this skill at references/org-profile-template.md, so copy it, fill it in and save it as /Documents/Cowork/org-profile.md.
4. Read the artifact end to end before forming any finding. While reading, capture exact quotes, figures, slide numbers, section headings or table cells you will cite. Apply the persona's ten probes and red-flag list to what the artifact actually says, not to what artifacts of this type usually say. Where the artifact is silent on a probe (no downside case, no staging, no exit cost), record that silence as an open question, never as an invented fact.
5. Compose the review with exactly these five sections, in this order:
   - VERDICT: exactly one of "ready", "ready with conditions" or "not ready", followed by a one-sentence justification in the persona's voice. If "ready with conditions", list the conditions as bullets, phrased as terms (gates, tranches, evidence required), the way this persona closes.
   - TOP FINDINGS: three to seven findings, most important first. Every finding must quote or cite the specific part of the artifact it is about (a quoted sentence, a slide number, a named section, a table cell). A finding that could be pasted under any business case is not a finding; cut it. Where the artifact says nothing on a probe, the finding states the silence and poses the open question.
   - RISKS: the material risks visible from the investor lens (capital at risk before first evidence, opportunity cost, missing staging, downside and unwind costs, sponsor credibility signals in the document itself). Cite where in the artifact each risk arises, or state explicitly that the artifact is silent on it.
   ...
   - 5 INTERROGATION QUESTIONS: exactly five questions the real investor would ask in the meeting, in the persona's voice, ordered from the question most likely to open the meeting to the one most likely to close it. Draw on the persona's probes but anchor each question in this artifact's content.
6. Use the Word built-in skill to create the review as a .docx document. First line of the document: "DRAFT: Investor review of <artifact-name>, generated <date>". Then the five sections from step 5. Save it as <artifact-name>-investor-review.docx in /Documents/Cowork/reviews/. If the reviews folder does not exist, create it. If a file with that exact name already exists, do not overwrite it; save as <artifact-name>-investor-review-v2.docx (incrementing as needed) and tell the user why.
...
- /Documents/Cowork/reviews/<artifact-name>-investor-review.docx: the review document, labelled DRAFT on its first line, containing VERDICT, TOP FINDINGS, RISKS, WHAT WOULD CHANGE MY MIND and 5 INTERROGATION QUESTIONS.
...
- Very long artifact (over roughly 50 pages or 60 slides): review the executive summary, the ask, the financials and any staging or milestone sections in full, sample the rest, and state in the review document which sections were sampled rather than read in full.
...
- Review the work, not the person. The persona judges sponsor credibility from the document's contents (what it checked, what it omits), never from anything about the author as an individual.
- The persona is a role archetype. Never present its output as the opinion of any real, named investor or firm, and never imply a real funder has seen or endorsed the review.
...
- [ ] Every silence in the artifact is recorded as an open question, not filled with an invented fact.
