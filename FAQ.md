...
No Copilot licence at all? Start with [awesome-copilot-chat-agents](https://github.com/kesslernity/awesome-copilot-chat-agents): 82 agents that run on the free Copilot Chat tier included with any commercial M365 licence. The other routes are in the README's [Who This Is For](README.md#who-this-is-for) section.
